...
type StockLocation struct {
	...
	Purpose               warehouseenum.StockLocationPurpose        `json:"purpose"`
	HandlingMode          warehouseenum.StockLocationHandlingMode   `json:"handling_mode"`
	Access                warehouseenum.StockLocationAccess         `json:"access"`
	CollectionMode        warehouseenum.StockLocationCollectionMode `json:"collection_mode"`
...
type StockLocationCollectionEligibility struct {
	...
	Role         warehouseenum.StockLocationCollectionRole `json:"role"`
