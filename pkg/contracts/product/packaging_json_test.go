...
func TestProductPackageOptionsAndBarcodeAssignmentsJSON(t *testing.T) {
	...
	product := Product{
		...
		BarcodeAssignments: []ProductBarcodeAssignment{
			{ID: "barcode_each", ProductSKUCode: "A00001", PackageOptionID: "pkg_each", Value: "930000000001", Format: productenum.BarcodeFormatEAN13, IsPrimary: true, EffectiveFrom: effectiveFrom},
			{ID: "barcode_case", ProductSKUCode: "A00001", PackageOptionID: "pkg_case_12", Value: "19300000000018", Format: productenum.BarcodeFormatEAN13, IsPrimary: true, EffectiveFrom: effectiveFrom},
		},
	}
...
func TestBarcodeValueMayBeAssignedAcrossProducts(t *testing.T) {
	...
	products := []Product{
		{SKUCode: "A00001", Name: "First", BarcodeAssignments: []ProductBarcodeAssignment{{ID: "ba_1", ProductSKUCode: "A00001", PackageOptionID: "pkg_1", Value: "930000000001", Format: productenum.BarcodeFormatEAN13, EffectiveFrom: now}}},
		{SKUCode: "A00002", Name: "Second", BarcodeAssignments: []ProductBarcodeAssignment{{ID: "ba_2", ProductSKUCode: "A00002", PackageOptionID: "pkg_2", Value: "930000000001", Format: productenum.BarcodeFormatEAN13, EffectiveFrom: now}}},
	}
...
func TestSellableOfferSnapshotJSONFreezesPackageInventoryTimeAndGeography(t *testing.T) {
	...
	offer := SellableOfferSnapshot{
		...
		GeographicContext: common.GeographicContext{Source: geographyenum.GeographicContextSourceRetailCustomerProfile, CountryCode: "AU", SubdivisionCode: "AU-VIC", DepotCode: "AU-VIC-MEL-DC-01", ScopeRevision: 2, RuleRevision: 7, EvaluationTimezone: "Australia/Melbourne"},
	}
