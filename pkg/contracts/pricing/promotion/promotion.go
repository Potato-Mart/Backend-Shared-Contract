...
type Promotion struct {
	...
	RequiredQtyMode PromotionQtyMode `json:"required_qty_mode,omitempty"`
	...
	DiscountTarget PromotionDiscountTarget `json:"discount_target,omitempty"`
	...
	AddonTriggerMode    PromotionAddonTrigger `json:"addon_trigger_mode,omitempty"`
	...
	Channels        []common.OrderType        `json:"channels,omitempty"` // e.g. ["online","pos"]
