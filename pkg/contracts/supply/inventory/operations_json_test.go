...
import (
	...
	fulfilment "github.com/Potato-Mart/Backend-Shared-Contract/v36/pkg/contracts/supply/fulfilment"
...
func TestReservationAndStagingJSONShapes(t *testing.T) {
	...
	reservationShape := marshalObject(t, operations.StockReservation{
		ID: "reservation_1", SKUCode: "A00001", DepotCode: "AU-VIC-MEL-DC-01",
		MarketCode: "market_au", EligibilityToken: "eligibility_token_1", ListingRevision: 9,
...
func TestPackingPickingAndAvailabilityEventJSONShapes(t *testing.T) {
	...
	containerShape := marshalObject(t, fulfilment.OutboundContainerPlan{
	...
	lineShape := marshalObject(t, fulfilment.PackingLine{
		...
		Substitutions:       []fulfilment.PackageSubstitutionSnapshot{substitution},
	})
	...
	pickingShape := marshalObject(t, fulfilment.PickingListItem{
		ID:                     "picking_item_1",
