...
// and how its price/listing is exposed. It reuses common.OrderType for
...
type Selling struct {
	Channels   []common.OrderType       `json:"channels,omitempty"`
	BuyerTypes []customerenum.BuyerType `json:"buyer_types,omitempty"`
	Visibility PriceVisibility          `json:"visibility,omitempty"`
}
