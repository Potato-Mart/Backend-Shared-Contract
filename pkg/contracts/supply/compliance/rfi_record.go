...
type RFIRecord struct {
	...
	Channel                compliance_enums.RFIChannel         `json:"channel"`
	CurrentSubmissionState compliance_enums.RFISubmissionState `json:"current_submission_state"`
	...
	RequestedTime          compliance_enums.RFIRequestedTime   `json:"requested_time"`
