...
type RFIRecord struct {
	...
	Channel                RFIChannel            `json:"channel"`
	CurrentSubmissionState RFISubmissionState    `json:"current_submission_state"`
	...
	RequestedTime          RFIRequestedTime      `json:"requested_time"`
...
type RFIExternalEvent struct {
	ID                string              `json:"id"`
	State             RFISubmissionState  `json:"state"`
