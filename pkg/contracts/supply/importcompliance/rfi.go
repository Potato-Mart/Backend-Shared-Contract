...
type RFIRecord struct {
	...
	Channel                importcompliance_enums.RFIChannel         `json:"channel"`
	CurrentSubmissionState importcompliance_enums.RFISubmissionState `json:"current_submission_state"`
	...
	RequestedTime          importcompliance_enums.RFIRequestedTime   `json:"requested_time"`
...
type RFIExternalEvent struct {
	ID                string                                    `json:"id"`
	State             importcompliance_enums.RFISubmissionState `json:"state"`
