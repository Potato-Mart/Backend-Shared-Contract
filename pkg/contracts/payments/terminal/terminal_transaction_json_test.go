...
import (
	...
	payment "github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/payments/payment"
	"github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/payments/provider"
	settlement "github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/payments/settlement"
	"github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/payments/settlement/settlement_enums"
	terminal "github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/payments/terminal"
...
func TestTerminalTransactionJSONRoundTripWithHistory(t *testing.T) {
	...
	tx := terminal.TerminalTransaction{
		...
		ProviderReference: &payment.PaymentReference{
			Mx51: &provider.Mx51PaymentReference{
