...
import (
	...
	fulfilment "github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/orders/fulfilment"
	group_order "github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/orders/group_order"
	group_order_enums "github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/orders/group_order/group_order_enums"
	...
	"github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/pricing/quote"
	"github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/pricing/quote/quote_enums"
	"github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/supply/catalogue/listing"
	"github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/supply/catalogue/product"
	supplyfulfilment "github.com/Potato-Mart/Backend-Shared-Contract/v34/pkg/contracts/supply/fulfilment"
...
func TestRetailOrderItemJSONPreservesMixedCaseAndEachPricing(t *testing.T) {
	...
	item := sales.OrderItem{
		...
		CapturedAt:           now,
		Components: []fulfilment.PricedPackageComponent{
...
func TestGroupOrderFulfilmentJSONUsesOneParentAllocation(t *testing.T) {
	...
	participantComponent := fulfilment.PricedPackageComponent{
