...
import (
	...
	warehouse "github.com/Potato-Mart/Backend-Shared-Contract/v23/pkg/contracts/supply/warehouse"
	"time"
)
...
type StockLocationAvailabilityChangedEvent struct {
	...
	Direction                warehouse.StockAvailabilityDirection `json:"direction"`
...
type InventoryStockBucketChangedEvent struct {
	...
	Condition                warehouse.InventoryCondition   `json:"condition"`
	Disposition              warehouse.InventoryDisposition `json:"disposition"`
...
type InventoryQualityAssessedEvent struct {
	...
	PreviousCondition   warehouse.InventoryCondition      `json:"previous_condition"`
	ResultCondition     warehouse.InventoryCondition      `json:"result_condition"`
	PreviousDisposition warehouse.InventoryDisposition    `json:"previous_disposition"`
	ResultDisposition   warehouse.InventoryDisposition    `json:"result_disposition"`
...
type InventoryReservationChangedEvent struct {
	...
	ProductSKUCode       string                            `json:"product_sku_code"`
	DepotCode            string                            `json:"depot_code"`
	PreviousStatus       warehouse.StockReservationStatus  `json:"previous_status,omitempty"`
	Status               warehouse.StockReservationStatus  `json:"status"`
...
type InventoryDateMarkThresholdEvent struct {
	...
	Threshold      warehouse.InventoryDateMarkThreshold `json:"threshold"`
