...
import (
	...
	campaign "github.com/Potato-Mart/Backend-Shared-Contract/v23/pkg/contracts/customers/campaign"
)
...
type CampaignChangedEvent struct {
	...
	Status             campaign.CampaignStatus       `json:"status"`
	IsActive           bool                          `json:"is_active"`
	ScopeMode          geography.GeographicScopeMode `json:"scope_mode"`
