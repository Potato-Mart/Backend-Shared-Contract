...
func TestMembershipEnumsValidateKnownValues(t *testing.T) {
	assertStringEnums(t, []enumCase{
		...
		{name: "membershipenum.MembershipPromotionTarget", valid: []stringEnum{membership_enums.MembershipPromotionTargetAll, membership_enums.MembershipPromotionTargetRetail, membership_enums.MembershipPromotionTargetTierSpecific}, invalid: membership_enums.MembershipPromotionTarget("__invalid__")},
