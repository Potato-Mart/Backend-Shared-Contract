...
func TestOrderEnumsValidateKnownValues(t *testing.T) {
	assertStringEnums(t, []enumCase{
		...
		{name: "orderenum.GroupOrderRole", valid: []stringEnum{group_order_enums.GroupOrderRoleConsolidatedParent, group_order_enums.GroupOrderRoleParticipant}, invalid: group_order_enums.GroupOrderRole("__invalid__")},
		{name: "orderenum.FulfillmentStatus", valid: []stringEnum{order_enums.FulfillmentStatusUnfulfilled, order_enums.FulfillmentStatusPickingPrinted, order_enums.FulfillmentStatusPacking, order_enums.FulfillmentStatusPacked, order_enums.FulfillmentStatusPartial, order_enums.FulfillmentStatusFulfilled, order_enums.FulfillmentStatusCancelled}, invalid: order_enums.FulfillmentStatus("__invalid__")},
