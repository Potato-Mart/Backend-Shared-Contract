...
import (
	...
	"github.com/Potato-Mart/Backend-Shared-Contract/v36/pkg/contracts/payments/settlement/settlement_enums"
	"github.com/Potato-Mart/Backend-Shared-Contract/v36/pkg/contracts/payments/terminal/terminal_enums"
)

func TestPaymentEnumsValidateKnownValues(t *testing.T) {
	assertStringEnums(t, []enumCase{
		{name: "paymentenum.BusinessNumberScheme", valid: []stringEnum{payment_enums.BusinessNumberSchemeABN, payment_enums.BusinessNumberSchemeACN, payment_enums.BusinessNumberSchemeNZBN, payment_enums.BusinessNumberSchemeUEN, payment_enums.BusinessNumberSchemeVAT, payment_enums.BusinessNumberSchemeEIN, payment_enums.BusinessNumberSchemeOther}, invalid: payment_enums.BusinessNumberScheme("__invalid__")},
		{name: "paymentenum.TaxRegistrationStatus", valid: []stringEnum{payment_enums.TaxRegistrationStatusRegistered, payment_enums.TaxRegistrationStatusNotRegistered, payment_enums.TaxRegistrationStatusUnknown}, invalid: payment_enums.TaxRegistrationStatus("__invalid__")},
		{name: "paymentenum.MerchantProfileStatus", valid: []stringEnum{payment_enums.MerchantProfileStatusDraft, payment_enums.MerchantProfileStatusActive, payment_enums.MerchantProfileStatusInactive}, invalid: payment_enums.MerchantProfileStatus("__invalid__")},
		{name: "paymentenum.DocumentKind", valid: []stringEnum{payment_enums.DocumentKindReceipt, payment_enums.DocumentKindTaxInvoice, payment_enums.DocumentKindInvoice, payment_enums.DocumentKindAdjustmentNote}, invalid: payment_enums.DocumentKind("__invalid__")},
		{name: "paymentenum.PaymentMethod", valid: []stringEnum{payment_enums.PaymentMethodCard, payment_enums.PaymentMethodCash, payment_enums.PaymentMethodQR, payment_enums.PaymentMethodBankTransfer, payment_enums.PaymentMethodPayTo, payment_enums.PaymentMethodLink, payment_enums.PaymentMethodLinePay, payment_enums.PaymentMethodApplePay, payment_enums.PaymentMethodGooglePay, payment_enums.PaymentMethodECPay, payment_enums.PaymentMethodManual, payment_enums.PaymentMethodGiftCard, payment_enums.PaymentMethodEFTPOS, payment_enums.PaymentMethodMOTO, payment_enums.PaymentMethodCashout}, invalid: payment_enums.PaymentMethod("__invalid__")},
