...
func TestPurchaseEnumsValidateKnownValues(t *testing.T) {
	assertStringEnums(t, []enumCase{
		...
		{name: "purchaseenum.PurchaseReceiptStatus", valid: []stringEnum{purchase_enums.PurchaseReceiptStatusDraft, purchase_enums.PurchaseReceiptStatusConfirmed}, invalid: purchase_enums.PurchaseReceiptStatus("__invalid__")},
	})
}
