...
func remapCutoverTypePolicies(policy map[string]map[string]struct{}) {
	for oldKey, newKey := range map[string]string{
		...
		"supply/purchase.OrderItem":                   "supply/procurement.OrderItem",
		"supply/purchase.ReceiptItem":                 "supply/procurement.ReceiptItem",
		...
		"supply/operations.InboundItem":               "supply/warehouse.InboundItem",
