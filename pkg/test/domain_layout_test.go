...
func TestDomainPackageLayout(t *testing.T) {
	...
	requiredFiles := map[string]string{
		...
		"contracts/common/money/currency_code.go":                                           "money",
		...
		"contracts/pricing/promotion/promotion_scope.go":                                    "promotion",
		"contracts/pricing/promotion/promotion_relation.go":                                 "promotion",
		"contracts/pricing/promotion/promotion_application.go":                              "promotion",
		...
		"contracts/orders/pos/cash_rounding_snapshot.go":                                    "pos",
