...
type DataProtectionFields struct {
	Classification       securityenum.DataClassification  `json:"classification,omitempty"`
	ProtectionBasis      securityenum.DataProtectionBasis `json:"protection_basis,omitempty"`
